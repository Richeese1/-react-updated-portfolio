...
import { FacebookIcon, GithubIcon, InstagramIcon, LinkedinIcon, Mail, MapIcon, Phone, Send } from "lucide-react";
                ...
                <div className="space-y-8">
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a href="https://www.facebook.com/richard.lopez.402180" target="_blank">
                                <FacebookIcon/>
                            </a>
                            <a href="https://github.com/Richeese1" target="_blank">
                                <GithubIcon/>
                            </a>
                            <a href="https://www.instagram.com/ritsaaaaarrrd/" target="_blank">
                                <InstagramIcon/>
                            </a>
                        </div>
                    </div>  
